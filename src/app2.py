...
with open('/workspaces/streamlit/models/LinearRegression.sav', 'rb') as file:
    model = pickle.load(file)
with open('/workspaces/streamlit/models/scaler.pkl', 'rb') as scaler_file:
    scaler = pickle.load(scaler_file)
st.title('Charges Prediction')
